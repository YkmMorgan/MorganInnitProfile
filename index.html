<html><head>
  ...
  <link rel="shortcut icon" type="image/png" href="pog.png">
  <style>
  p {}
...
</head><body oncontextmenu="if (!window.__cfRLUnblockHandlers) return false; return false;" unselectable="on" onselectstart="if (!window.__cfRLUnblockHandlers) return false; return false;" data-new-gr-c-s-check-loaded="14.983.0">
  <canvas width="1035" height="979"></canvas>
  <title>‎</title>
  <embed src="Songs/Song6-Quieter.mp3" hidden="true" autostart="true" loop="true">
  <style>
      * {
  ...
  <div class="center">
      <center>
          <pre>    
<img src="https://i.pinimg.com/originals/39/38/4b/39384b05e6b0e2cfb9bec074dfcecd1c.jpg" width="190" height="200">

<center><a href="https://discord.bio/p/morganinnit" target=”_blank” style="color:blueviolet">Bio</a>

<a href="https://discord.gg/ShaqHag" target="_blank" style="color:#7289d9">Server</a>

<a href="https://lelllll.000webhostapp.com/" target="_blank" style="color:darkgreen">Zinexium Website</a>

<a href="https://v3rmillion.net/member.php?action=profile&uid=1872257" target="_blank" style="color:#FF0000">V3rmillion</a></pre></center>
...
<p id="date" style="color:#ffffff;">friday, november 13</p><p id="clockDisplay" style="color:#ffffff">10:50:02 AM</p></pre></pre>
                  </div>
                  <style>
                      html,
                      body {
